...
card_id			equ	109
card_no			equ	"109"
card_sub		equ	"Mod Card 109"
card_sub_x		equ	64
card_desc_len		equ	3
card_desc_1		equ	"Address 0C"
card_desc_2		equ	"MegaFolder3"
card_desc_3		equ	"Buggy"
card_name_jp_full	equ	"メガフォルダ3"
card_name_jp_game	equ	"メガフォルダ3"
card_name_en_full	equ	"MegaFolder3"
card_name_en_game	equ	"MegaFolder3"

card_address		equ	"0C"
card_address_id		equ	2
card_bug		equ	1
card_wrote_en		equ	"MegaFolder3"
card_wrote_jp		equ	"メガフォルダ3"