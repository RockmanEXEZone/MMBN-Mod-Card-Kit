...
card_desc_2		equ	"Buster Attack10"
card_desc_3		equ	"Buggy"
card_name_jp_full	equ	"バスター攻撃力10"
card_name_jp_game	equ	"バスター攻撃力10"
card_name_en_full	equ	"Buster Attack10"
card_name_en_game	equ	"Buster Attack10"

card_address		equ	"0A"
card_address_id		equ	0
card_bug		equ	1
card_wrote_en		equ	"Buster Attack10"
card_wrote_jp		equ	"バスター攻撃力10"