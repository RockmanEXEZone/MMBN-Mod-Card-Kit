...
card_name_jp_full	equ	"PET画面カラー:グリーン"
card_name_jp_game	equ	"PET画面カラー:グリーン"
card_name_en_full	equ	"PET Screen Color: Green"
card_name_en_game	equ	"PET Scrn Color: Green"

card_address		equ	"0F"
card_address_id		equ	5
card_bug		equ	0
card_wrote_en		equ	"PET Scrn Color: Green"
card_wrote_jp		equ	"PET画面カラー:グリーン"