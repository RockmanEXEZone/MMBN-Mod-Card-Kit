...
card_id			equ	121
card_no			equ	"121"
card_sub		equ	"Mod Card 121"
card_sub_x		equ	64
card_desc_len		equ	3
card_desc_1		equ	"Address 0E"
card_desc_2		equ	"RollSoul (Buggy)"
card_desc_3		equ	"Red Sun only"
card_name_jp_full	equ	"ロールソウル"
card_name_jp_game	equ	"ロールソウル"
card_name_en_full	equ	"RollSoul"
card_name_en_game	equ	"RollSoul"

card_address		equ	"0E"
card_address_id		equ	4
card_bug		equ	1
card_wrote_en		equ	"RollSoul"
card_wrote_jp		equ	"ロールソウル"