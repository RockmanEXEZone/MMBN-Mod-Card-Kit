...
card_id			equ	12
card_no			equ	"012"
card_sub		equ	"Mod Card 012"
card_sub_x		equ	64
card_desc_len		equ	3
card_desc_1		equ	"Address 0A"
card_desc_2		equ	"BlindBuster"
card_desc_3		equ	"Buggy"
card_name_jp_full	equ	"ブラインドバスター"
card_name_jp_game	equ	"ブラインドバスター"
card_name_en_full	equ	"BlindBuster"
card_name_en_game	equ	"BlindBuster"

card_address		equ	"0A"
card_address_id		equ	0
card_bug		equ	1
card_wrote_en		equ	"BlindBuster"
card_wrote_jp		equ	"ブラインドバスター"