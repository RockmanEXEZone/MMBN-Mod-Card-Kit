...
card_id			equ	102
card_no			equ	"102"
card_sub		equ	"Mod Card 102"
card_sub_x		equ	64
card_desc_len		equ	2
card_desc_1		equ	"Address 0A"
card_desc_2		equ	"IceBuster"
card_desc_3		equ	""
card_name_jp_full	equ	"アイスバスター"
card_name_jp_game	equ	"アイスバスター"
card_name_en_full	equ	"IceBuster"
card_name_en_game	equ	"IceBuster"

card_address		equ	"0A"
card_address_id		equ	0
card_bug		equ	0
card_wrote_en		equ	"IceBuster"
card_wrote_jp		equ	"アイスバスター"