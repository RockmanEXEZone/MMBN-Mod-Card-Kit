...
card_desc_2		equ	"Charge SandRing"
card_desc_3		equ	""
card_name_jp_full	equ	"チャージサンドリング"
card_name_jp_game	equ	"チャージサンドリング"
card_name_en_full	equ	"Charge SandRing"
card_name_en_game	equ	"Charge SandRing"

card_address		equ	"0E"
card_address_id		equ	4
card_bug		equ	0
card_wrote_en		equ	"Charge SandRing"
card_wrote_jp		equ	"チャージサンドリング"