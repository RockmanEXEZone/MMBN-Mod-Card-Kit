...
card_id			equ	132
card_no			equ	"132"
card_sub		equ	"Mod Card 132"
card_sub_x		equ	64
card_desc_len		equ	3
card_desc_1		equ	"Address 0E"
card_desc_2		equ	"WoodSoul (Buggy)"
card_desc_3		equ	"Blue Moon only"
card_name_jp_full	equ	"ウッドソウル"
card_name_jp_game	equ	"ウッドソウル"
card_name_en_full	equ	"WoodSoul"
card_name_en_game	equ	"WoodSoul"

card_address		equ	"0E"
card_address_id		equ	4
card_bug		equ	1
card_wrote_en		equ	"WoodSoul"
card_wrote_jp		equ	"ウッドソウル"