...
card_id			equ	127
card_no			equ	"127"
card_sub		equ	"Mod Card 127"
card_sub_x		equ	64
card_desc_len		equ	3
card_desc_1		equ	"Address 0E"
card_desc_2		equ	"ProtoSoul (Buggy)"
card_desc_3		equ	"Blue Moon only"
card_name_jp_full	equ	"ブルースソウル"
card_name_jp_game	equ	"ブルースソウル"
card_name_en_full	equ	"ProtoSoul"
card_name_en_game	equ	"ProtoSoul"

card_address		equ	"0E"
card_address_id		equ	4
card_bug		equ	1
card_wrote_en		equ	"ProtoSoul"
card_wrote_jp		equ	"ブルースソウル"