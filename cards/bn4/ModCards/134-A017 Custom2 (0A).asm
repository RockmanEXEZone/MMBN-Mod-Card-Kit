...
card_desc_2		equ	"Custom2"
card_desc_3		equ	"Buggy"
card_name_jp_full	equ	"カスタム2"
card_name_jp_game	equ	"カスタム2"
card_name_en_full	equ	"Custom2"
card_name_en_game	equ	"Custom2"

card_address		equ	"0A"
card_address_id		equ	0
card_bug		equ	1
card_wrote_en		equ	"Custom2"
card_wrote_jp		equ	"カスタム2"