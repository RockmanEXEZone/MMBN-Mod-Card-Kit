...
card_id			equ	67
card_no			equ	"067"
card_sub		equ	"Mod Card 067"
card_sub_x		equ	64
card_desc_len		equ	3
card_desc_1		equ	"Address 0A"
card_desc_2		equ	"MAX HP +700"
card_desc_3		equ	"Buggy"
card_name_jp_full	equ	"マックスHP+700"
card_name_jp_game	equ	"マックスHP+700"
card_name_en_full	equ	"MAX HP +700"
card_name_en_game	equ	"MAX HP +700"

card_address		equ	"0A"
card_address_id		equ	0
card_bug		equ	1
card_wrote_en		equ	"MAX HP +700"
card_wrote_jp		equ	"マックスHP+700"