...
card_id			equ	130
card_no			equ	"130"
card_sub		equ	"Mod Card 130"
card_sub_x		equ	64
card_desc_len		equ	3
card_desc_1		equ	"Address 0E"
card_desc_2		equ	"JunkSoul (Buggy)"
card_desc_3		equ	"Blue Moon only"
card_name_jp_full	equ	"ジャンクソウル"
card_name_jp_game	equ	"ジャンクソウル"
card_name_en_full	equ	"JunkSoul"
card_name_en_game	equ	"JunkSoul"

card_address		equ	"0E"
card_address_id		equ	4
card_bug		equ	1
card_wrote_en		equ	"JunkSoul"
card_wrote_jp		equ	"ジャンクソウル"