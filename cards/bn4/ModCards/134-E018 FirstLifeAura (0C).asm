...
card_desc_2		equ	"FirstLifeAura"
card_desc_3		equ	"Buggy"
card_name_jp_full	equ	"ファーストドリームオーラ"
card_name_jp_game	equ	"ファーストドリームオーラ"
card_name_en_full	equ	"FirstLifeAura"
card_name_en_game	equ	"FirstLifeAura"

card_address		equ	"0C"
card_address_id		equ	2
card_bug		equ	1
card_wrote_en		equ	"FirstLifeAura"
card_wrote_jp		equ	"ファーストドリームオーラ"