...
card_desc_2		equ	"MAX HP +600"
card_desc_3		equ	""
card_name_jp_full	equ	"マックスHP+600"
card_name_jp_game	equ	"マックスHP+600"
card_name_en_full	equ	"MAX HP +600"
card_name_en_game	equ	"MAX HP +600"

card_address		equ	"0C"
card_address_id		equ	2
card_bug		equ	0
card_wrote_en		equ	"MAX HP +600"
card_wrote_jp		equ	"マックスHP+600"