...
card_id			equ	35
card_no			equ	"035"
card_sub		equ	"Mod Card 035"
card_sub_x		equ	64
card_desc_len		equ	3
card_desc_1		equ	"Address 0B"
card_desc_2		equ	"MAX HP +450"
card_desc_3		equ	"Buggy"
card_name_jp_full	equ	"マックスHP+450"
card_name_jp_game	equ	"マックスHP+450"
card_name_en_full	equ	"MAX HP +450"
card_name_en_game	equ	"MAX HP +450"

card_address		equ	"0B"
card_address_id		equ	1
card_bug		equ	1
card_wrote_en		equ	"MAX HP +450"
card_wrote_jp		equ	"マックスHP+450"