...
card_desc_2		equ	"Charge Thunder2"
card_desc_3		equ	""
card_name_jp_full	equ	"チャージサンダーボール2"
card_name_jp_game	equ	"チャージサンダーボール2"
card_name_en_full	equ	"Charge Thunder2"
card_name_en_game	equ	"Charge Thunder2"

card_address		equ	"0E"
card_address_id		equ	4
card_bug		equ	0
card_wrote_en		equ	"Charge Thunder2"
card_wrote_jp		equ	"チャージサンダーボール2"