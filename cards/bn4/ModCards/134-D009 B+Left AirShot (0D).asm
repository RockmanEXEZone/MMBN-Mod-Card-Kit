...
card_desc_2		equ	"B+Left AirShot"
card_desc_3		equ	""
card_name_jp_full	equ	"B+左でエアシュート"
card_name_jp_game	equ	"B+左でエアシュート"
card_name_en_full	equ	"B+Left AirShot"
card_name_en_game	equ	"B+Left AirShot"

card_address		equ	"0D"
card_address_id		equ	3
card_bug		equ	0
card_wrote_en		equ	"B+Left AirShot"
