...
card_desc_2		equ	"AllGuard 1/2"
card_desc_3		equ	"Buggy"
card_name_jp_full	equ	"オールガード1/2"
card_name_jp_game	equ	"オールガード1/2"
card_name_en_full	equ	"AllGuard 1/2"
card_name_en_game	equ	"AllGuard 1/2"

card_address		equ	"0C"
card_address_id		equ	2
card_bug		equ	1
card_wrote_en		equ	"AllGuard 1/2"
card_wrote_jp		equ	"オールガード1/2"