...
card_id			equ	122
card_no			equ	"122"
card_sub		equ	"Mod Card 122"
card_sub_x		equ	64
card_desc_len		equ	3
card_desc_1		equ	"Address 0E"
card_desc_2		equ	"GutsSoul (Buggy)"
card_desc_3		equ	"Red Sun only"
card_name_jp_full	equ	"ガッツソウル"
card_name_jp_game	equ	"ガッツソウル"
card_name_en_full	equ	"GutsSoul"
card_name_en_game	equ	"GutsSoul"

card_address		equ	"0E"
card_address_id		equ	4
card_bug		equ	1
card_wrote_en		equ	"GutsSoul"
card_wrote_jp		equ	"ガッツソウル"