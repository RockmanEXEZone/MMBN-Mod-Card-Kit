...
card_id			equ	129
card_no			equ	"129"
card_sub		equ	"Mod Card 129"
card_sub_x		equ	64
card_desc_len		equ	3
card_desc_1		equ	"Address 0E"
card_desc_2		equ	"MetalSoul (Buggy)"
card_desc_3		equ	"Blue Moon only"
card_name_jp_full	equ	"メタルソウル"
card_name_jp_game	equ	"メタルソウル"
card_name_en_full	equ	"MetalSoul"
card_name_en_game	equ	"MetalSoul"

card_address		equ	"0E"
card_address_id		equ	4
card_bug		equ	1
card_wrote_en		equ	"MetalSoul"
card_wrote_jp		equ	"メタルソウル"