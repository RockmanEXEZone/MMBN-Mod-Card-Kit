...
card_desc_2		equ	"Charge BugBomb"
card_desc_3		equ	""
card_name_jp_full	equ	"チャージバグボム"
card_name_jp_game	equ	"チャージバグボム"
card_name_en_full	equ	"Charge BugBomb"
card_name_en_game	equ	"Charge BugBomb"

card_address		equ	"0E"
card_address_id		equ	4
card_bug		equ	0
card_wrote_en		equ	"Charge BugBomb"
card_wrote_jp		equ	"チャージバグボム"