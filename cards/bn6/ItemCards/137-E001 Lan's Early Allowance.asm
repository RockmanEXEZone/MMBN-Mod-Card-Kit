...
card_sub_x		equ	62
card_desc_len		equ	2
card_desc_1		equ	"Lan's Early"
card_desc_2		equ	"Allowance"
card_desc_3		equ	""
card_name_jp_full	equ	"熱斗のおこづかい前借り"
card_name_jp_game	equ	"熱斗のおこづかい前がり"
card_name_en_full	equ	"Lan's Early Allowance"
card_name_en_game	equ	"Lan's Early Allowance"

card_game_desc_jp_len	equ	3
card_game_desc_jp_1	equ	"熱斗のおこづかい前がり!"
card_game_desc_jp_2	equ	"1000ゼニー"
card_game_desc_jp_3	equ	"を手に入れた!"
card_game_desc_en_len	equ	2
card_game_desc_en_1	equ	"Lan's early allowance!"
