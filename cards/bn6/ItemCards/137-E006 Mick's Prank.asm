...
card_sub_x		equ	62
card_desc_len		equ	1
card_desc_1		equ	"Mick's Prank"
card_desc_2		equ	""
card_desc_3		equ	""
card_name_jp_full	equ	"コジローのイタズラ"
card_name_jp_game	equ	"コジローのイタズラ"
card_name_en_full	equ	"Mick's Prank"
card_name_en_game	equ	"Mick's Prank"

card_game_desc_jp_len	equ	3
card_game_desc_jp_1	equ	"コジローのイタズラ!"
card_game_desc_jp_2	equ	"バグのかけら 10コ"
card_game_desc_jp_3	equ	"を手に入れた!"
card_game_desc_en_len	equ	2
card_game_desc_en_1	equ	"Mick's prank!"
