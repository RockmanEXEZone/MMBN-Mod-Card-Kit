...
card_sub_x		equ	62
card_desc_len		equ	1
card_desc_1		equ	"Pat's Cookware"
card_desc_2		equ	""
card_desc_3		equ	""
card_name_jp_full	equ	"パクチーの料理道具"
card_name_jp_game	equ	"パクチーのりょうりどうぐ"
card_name_en_full	equ	"Pat's Cookware"
card_name_en_game	equ	"Pat's Cookware"

card_game_desc_jp_len	equ	3
card_game_desc_jp_1	equ	"パクチーのりょうりどうぐ!"
card_game_desc_jp_2	equ	"スラッシュマンのナビチップ"
card_game_desc_jp_3	equ	"3しゅるい を手に入れた!"
card_game_desc_en_len	equ	3
card_game_desc_en_1	equ	"Pat's cookware!"
card_game_desc_en_2	equ	"Got 3 types of"
card_game_desc_en_3	equ	"SlashMan NaviChips!"