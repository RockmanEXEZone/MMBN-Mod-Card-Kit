...
card_sub_x		equ	62
card_desc_len		equ	1
card_desc_1		equ	"Chaud's Duty"
card_desc_2		equ	""
card_desc_3		equ	""
card_name_jp_full	equ	"炎山の任務"
card_name_jp_game	equ	"炎山のにんむ"
card_name_en_full	equ	"Chaud's Duty"
card_name_en_game	equ	"Chaud's Duty"

card_game_desc_jp_len	equ	3
card_game_desc_jp_1	equ	"炎山のにんむ!"
card_game_desc_jp_2	equ	"ブルースのナビチップ"
card_game_desc_jp_3	equ	"3しゅるい を手に入れた!"
card_game_desc_en_len	equ	3
card_game_desc_en_1	equ	"Chaud's duty!"
