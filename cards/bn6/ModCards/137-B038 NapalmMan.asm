...
card_sub_x		equ	64
card_desc_len		equ	2
card_desc_1		equ	"NapalmMan"
card_desc_2		equ	"39MB"
card_desc_3		equ	""
card_name_jp_full	equ	"ナパームマン"
card_name_jp_game	equ	"ナパームマン"
card_name_en_full	equ	"NapalmMan"
card_name_en_game	equ	"NapalmMan"
