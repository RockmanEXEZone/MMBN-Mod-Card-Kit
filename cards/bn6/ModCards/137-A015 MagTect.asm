...
card_sub_x		equ	64
card_desc_len		equ	2
card_desc_1		equ	"MagTect"
card_desc_2		equ	"15MB"
card_desc_3		equ	""
card_name_jp_full	equ	"マグテクト"
card_name_jp_game	equ	"マグテクト"
card_name_en_full	equ	"MagTect"
card_name_en_game	equ	"MagTect"
