...
card_sub_x		equ	53
card_desc_len		equ	2
card_desc_1		equ	"Django"
card_desc_2		equ	"52MB"
card_desc_3		equ	""
card_name_jp_full	equ	"ジャンゴ"
card_name_jp_game	equ	"ジャンゴ"
card_name_en_full	equ	"Django"
card_name_en_game	equ	"Django"
