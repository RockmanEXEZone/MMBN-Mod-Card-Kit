...
card_sub_x		equ	64
card_desc_len		equ	2
card_desc_1		equ	"BlastMan"
card_desc_2		equ	"28MB"
card_desc_3		equ	""
card_name_jp_full	equ	"ブラストマン"
card_name_jp_game	equ	"ブラストマン"
card_name_en_full	equ	"BlastMan"
card_name_en_game	equ	"BlastMan"
