...
card_sub_x		equ	64
card_desc_len		equ	2
card_desc_1		equ	"ChargeMan"
card_desc_2		equ	"31MB"
card_desc_3		equ	""
card_name_jp_full	equ	"チャージマン"
card_name_jp_game	equ	"チャージマン"
card_name_en_full	equ	"ChargeMan"
card_name_en_game	equ	"ChargeMan"
