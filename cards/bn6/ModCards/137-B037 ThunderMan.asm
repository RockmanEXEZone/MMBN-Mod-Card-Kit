...
card_sub_x		equ	64
card_desc_len		equ	2
card_desc_1		equ	"ThunderMan"
card_desc_2		equ	"36MB"
card_desc_3		equ	""
card_name_jp_full	equ	"サンダーマン"
card_name_jp_game	equ	"サンダーマン"
card_name_en_full	equ	"ThunderMan"
card_name_en_game	equ	"ThunderMan"
