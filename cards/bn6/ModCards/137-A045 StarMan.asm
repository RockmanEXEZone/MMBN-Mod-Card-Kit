...
card_sub_x		equ	64
card_desc_len		equ	2
card_desc_1		equ	"StarMan"
card_desc_2		equ	"32MB"
card_desc_3		equ	""
card_name_jp_full	equ	"スターマン"
card_name_jp_game	equ	"スターマン"
card_name_en_full	equ	"StarMan"
card_name_en_game	equ	"StarMan"
