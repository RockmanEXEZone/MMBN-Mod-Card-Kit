...
card_sub_x		equ	64
card_desc_len		equ	2
card_desc_1		equ	"FighterPlane"
card_desc_2		equ	"20MB"
card_desc_3		equ	""
card_name_jp_full	equ	"ゼロプレーン"
card_name_jp_game	equ	"ゼロプレーン"
card_name_en_full	equ	"FighterPlane"
card_name_en_game	equ	"FighterPlane"
