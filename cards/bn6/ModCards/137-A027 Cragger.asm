...
card_sub_x		equ	64
card_desc_len		equ	2
card_desc_1		equ	"Cragger"
card_desc_2		equ	"19MB"
card_desc_3		equ	""
card_name_jp_full	equ	"レムゴン"
card_name_jp_game	equ	"レムゴン"
card_name_en_full	equ	"Cragger"
card_name_en_game	equ	"Cragger"
