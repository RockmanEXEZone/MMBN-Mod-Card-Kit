...
card_sub_x		equ	53
card_desc_len		equ	2
card_desc_1		equ	"Dark MegaMan"
card_desc_2		equ	"80MB"
card_desc_3		equ	""
card_name_jp_full	equ	"ダークロックマン"
card_name_jp_game	equ	"ダークロックマン"
card_name_en_full	equ	"Dark MegaMan"
card_name_en_game	equ	"Dark MegaMan"
