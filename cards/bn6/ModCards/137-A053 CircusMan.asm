...
card_sub_x		equ	64
card_desc_len		equ	2
card_desc_1		equ	"CircusMan"
card_desc_2		equ	"43MB"
card_desc_3		equ	""
card_name_jp_full	equ	"サーカスマン"
card_name_jp_game	equ	"サーカスマン"
card_name_en_full	equ	"CircusMan"
card_name_en_game	equ	"CircusMan"
