...
card_sub_x		equ	64
card_desc_len		equ	2
card_desc_1		equ	"DiveMan"
card_desc_2		equ	"42MB"
card_desc_3		equ	""
card_name_jp_full	equ	"ダイブマン"
card_name_jp_game	equ	"ダイブマン"
card_name_en_full	equ	"DiveMan"
card_name_en_game	equ	"DiveMan"
