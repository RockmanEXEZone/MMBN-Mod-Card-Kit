...
card_id			equ	66
card_no			equ	"066"
card_sub		equ	"Mod Card 066"
card_sub_x		equ	64
card_desc_len		equ	2
card_desc_1		equ	"Needler"
card_desc_2		equ	"10MB"
card_desc_3		equ	""
card_name_jp_full	equ	"ニドキャスター"
card_name_jp_game	equ	"ニドキャスター"
card_name_en_full	equ	"Needler"
card_name_en_game	equ	"Needler"
