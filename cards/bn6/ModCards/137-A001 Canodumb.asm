...
card_id			equ	1
card_no			equ	"001"
card_sub		equ	"Mod Card 001"
card_sub_x		equ	64
card_desc_len		equ	2
card_desc_1		equ	"Canodumb"
card_desc_2		equ	"10MB"
card_desc_3		equ	""
card_name_jp_full	equ	"キャノーダム"
card_name_jp_game	equ	"キャノーダム"
card_name_en_full	equ	"Canodumb"
card_name_en_game	equ	"Canodumb"
