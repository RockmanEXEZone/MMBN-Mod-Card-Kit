...
card_sub_x		equ	64
card_desc_len		equ	2
card_desc_1		equ	"ShadowMan"
card_desc_2		equ	"38MB"
card_desc_3		equ	""
card_name_jp_full	equ	"シャドーマン"
card_name_jp_game	equ	"シャドーマン"
card_name_en_full	equ	"ShadowMan"
card_name_en_game	equ	"ShadowMan"
