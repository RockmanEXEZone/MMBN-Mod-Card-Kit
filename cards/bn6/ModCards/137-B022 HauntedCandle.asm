...
card_sub_x		equ	64
card_desc_len		equ	2
card_desc_1		equ	"HauntedCandle"
card_desc_2		equ	"12MB"
card_desc_3		equ	""
card_name_jp_full	equ	"ドルダーラ"
card_name_jp_game	equ	"ドルダーラ"
card_name_en_full	equ	"HauntedCandle"
card_name_en_game	equ	"HauntedCandle"
