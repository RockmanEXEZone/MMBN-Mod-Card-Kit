...
card_sub_x		equ	64
card_desc_len		equ	2
card_desc_1		equ	"Scarecrow"
card_desc_2		equ	"14MB"
card_desc_3		equ	""
card_name_jp_full	equ	"カカジー"
card_name_jp_game	equ	"カカジー"
card_name_en_full	equ	"Scarecrow"
card_name_en_game	equ	"Scarecrow"
