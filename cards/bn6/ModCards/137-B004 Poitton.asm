...
card_sub_x		equ	64
card_desc_len		equ	2
card_desc_1		equ	"Poitton"
card_desc_2		equ	"13MB"
card_desc_3		equ	""
card_name_jp_full	equ	"ポイットン"
card_name_jp_game	equ	"ポイットン"
card_name_en_full	equ	"Poitton"
card_name_en_game	equ	"Poitton"
