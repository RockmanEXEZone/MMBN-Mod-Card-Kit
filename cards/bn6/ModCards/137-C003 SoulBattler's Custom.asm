...
card_sub_x		equ	53
card_desc_len		equ	2
card_desc_1		equ	"SoulBattler's Custom"
card_desc_2		equ	"66MB"
card_desc_3		equ	""
card_name_jp_full	equ	"Sバトラーのカスタマイズ"
card_name_jp_game	equ	"ソウルバトラーのカスタマイズ"
card_name_en_full	equ	"SoulBattler's Custom"
card_name_en_game	equ	"SoulBattler's Custom"
