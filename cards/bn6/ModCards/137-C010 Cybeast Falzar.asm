...
card_sub_x		equ	53
card_desc_len		equ	2
card_desc_1		equ	"Cybeast Falzar"
card_desc_2		equ	"70MB"
card_desc_3		equ	""
card_name_jp_full	equ	"電脳獣ファルザー"
card_name_jp_game	equ	"電脳獣ファルザー"
card_name_en_full	equ	"Cybeast Falzar"
card_name_en_game	equ	"Cybeast Falzar"
