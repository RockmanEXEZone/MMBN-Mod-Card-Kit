...
card_sub_x		equ	64
card_desc_len		equ	2
card_desc_1		equ	"DarkMech"
card_desc_2		equ	"22MB"
card_desc_3		equ	""
card_name_jp_full	equ	"アサシンメカ"
card_name_jp_game	equ	"アサシンメカ"
card_name_en_full	equ	"DarkMech"
card_name_en_game	equ	"DarkMech"
