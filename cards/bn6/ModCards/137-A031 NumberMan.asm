...
card_id			equ	31
card_no			equ	"031"
card_sub		equ	"Mod Card 031"
card_sub_x		equ	64
card_desc_len		equ	2
card_desc_1		equ	"NumberMan"
card_desc_2		equ	"35MB"
card_desc_3		equ	""
card_name_jp_full	equ	"ナンバーマン"
card_name_jp_game	equ	"ナンバーマン"
card_name_en_full	equ	"NumberMan"
card_name_en_game	equ	"NumberMan"
