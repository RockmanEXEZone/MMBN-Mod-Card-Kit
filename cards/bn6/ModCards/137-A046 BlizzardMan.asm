...
card_sub_x		equ	64
card_desc_len		equ	2
card_desc_1		equ	"BlizzardMan"
card_desc_2		equ	"30MB"
card_desc_3		equ	""
card_name_jp_full	equ	"ブリザードマン"
card_name_jp_game	equ	"ブリザードマン"
card_name_en_full	equ	"BlizzardMan"
card_name_en_game	equ	"BlizzardMan"
