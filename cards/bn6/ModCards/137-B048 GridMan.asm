...
card_sub_x		equ	64
card_desc_len		equ	2
card_desc_1		equ	"GridMan"
card_desc_2		equ	"48MB"
card_desc_3		equ	""
card_name_jp_full	equ	"フットマン"
card_name_jp_game	equ	"フットマン"
card_name_en_full	equ	"GridMan"
card_name_en_game	equ	"GridMan"
