...
card_sub_x		equ	64
card_desc_len		equ	2
card_desc_1		equ	"Draggin"
card_desc_2		equ	"11MB"
card_desc_3		equ	""
card_name_jp_full	equ	"ドラグリン"
card_name_jp_game	equ	"ドラグリン"
card_name_en_full	equ	"Draggin"
card_name_en_game	equ	"Draggin"
