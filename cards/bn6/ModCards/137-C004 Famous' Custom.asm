...
card_sub_x		equ	53
card_desc_len		equ	2
card_desc_1		equ	"Famous' Custom"
card_desc_2		equ	"69MB"
card_desc_3		equ	""
card_name_jp_full	equ	"名人の超絶カスタマイズ"
card_name_jp_game	equ	"名人のちょうぜつカスタマイズ"
card_name_en_full	equ	"Famous' Custom"
card_name_en_game	equ	"Famous' Custom"
