...
card_sub_x		equ	64
card_desc_len		equ	2
card_desc_1		equ	"CloudMan"
card_desc_2		equ	"40MB"
card_desc_3		equ	""
card_name_jp_full	equ	"クラウドマン"
card_name_jp_game	equ	"クラウドマン"
card_name_en_full	equ	"CloudMan"
card_name_en_game	equ	"CloudMan"
