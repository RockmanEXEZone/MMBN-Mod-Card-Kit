...
card_sub_x		equ	64
card_desc_len		equ	2
card_desc_1		equ	"BurnerMan"
card_desc_2		equ	"29MB"
card_desc_3		equ	""
card_name_jp_full	equ	"バーナーマン"
card_name_jp_game	equ	"バーナーマン"
card_name_en_full	equ	"BurnerMan"
card_name_en_game	equ	"BurnerMan"
