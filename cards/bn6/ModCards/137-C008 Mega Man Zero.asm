...
card_sub_x		equ	53
card_desc_len		equ	2
card_desc_1		equ	"Mega Man Zero"
card_desc_2		equ	"45MB"
card_desc_3		equ	""
card_name_jp_full	equ	"ロックマンゼロ"
card_name_jp_game	equ	"ロックマンゼロ"
card_name_en_full	equ	"Mega Man Zero"
card_name_en_game	equ	"Mega Man Zero"
