...
card_sub_x		equ	32
card_name_jp_full	equ	"ウイルスを見つけだせ!"
card_name_jp_game	equ	"ウイルスを見つけだせ!"
card_name_en_full	equ	"Find The Virus!"
card_name_en_game	equ	"Find The Virus!"
card_desc_len		equ	1
card_desc_1		equ	"Find The Virus!"
card_desc_2		equ	""
card_desc_3		equ	""